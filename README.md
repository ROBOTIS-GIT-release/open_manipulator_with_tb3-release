## open_manipulator_with_tb3 (melodic) - 1.1.0-2

The packages in the `open_manipulator_with_tb3` repository were released into the `melodic` distro by running `/usr/bin/bloom-release open_manipulator_with_tb3 -t melodic -r melodic --edit` on `Tue, 12 Feb 2019 00:52:47 -0000`
...
## open_manipulator_with_tb3 (melodic) - 1.1.0-1
