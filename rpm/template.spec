Name:           ros-melodic-open-manipulator-with-tb3-waffle-pi-moveit
Version:        1.1.0
Release:        2%{?dist}
Summary:        ROS open_manipulator_with_tb3_waffle_pi_moveit package
...
BuildRequires:  ros-melodic-open-manipulator-with-tb3-description

%description
An automatically generated package with all the configuration and launch files
for using the om_with_tb3 with the MoveIt! Motion Planning Framework
