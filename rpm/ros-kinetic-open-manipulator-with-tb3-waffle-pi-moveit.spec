Name:           ros-kinetic-open-manipulator-with-tb3-waffle-pi-moveit
Version:        1.0.1
Release:        0%{?dist}
...
License:        Apache 2.0
URL:            http://wiki.ros.org/open_manipulator_with_tb3_waffle_pi_moveit
...
files for OpenManipulator with TurtleBot3 Waffle Pi by using MoveIt! Motion
Planning Framework.
